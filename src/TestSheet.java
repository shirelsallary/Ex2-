...
public class TestSheet {
    ...
    public void testdepth() {
        ...
        sheet.canBeComputedNow("D0", new ArrayList<>(), "=C0+C1");
...
//1   -2  -1 -2
    ...
    System.out.println( sheet.eval(2,0));
     ...
     System.out.println( sheet.eval(3,0));
     System.out.println( sheet.eval(3,1));
     System.out.println( sheet.eval(3,2));
     System.out.println( sheet.eval(3,3));
